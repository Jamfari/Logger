...
public class Logger { 
	...
	// On définit la Méthode, sa visibilité (public), son type de retour (static), son nom (getInstance) et son paramètre (ici aucun)
	...
	// appel de méthode : objet.method();  | classe.attribut | this.attribut | this.methode(); pour une réf dans la classe
	...
	// Méthode s'appelle log, est visible à l'intérieur de la classe Logger seulement (private), ne retourne rien (void), et a 2 paramètres (une variable et une chaine de caractères)
